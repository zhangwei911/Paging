...
class CommonViewModel<T, E : Parcelable, Q : Parcelable>(
    ...
    companion object {
        ...
        fun <K : Serializable, D : Parcelable, N : Parcelable, Q : Parcelable> getViewModel(
            ...
            val repo = ServiceLocator.instance(fragment.requireContext()).getCommonNewRepository(type, httpCallback, formatItems, keyMethodName = keyMethodName,insertResultIntoDb = insertResultIntoDb,networkPageSize = networkPageSize,afterMethodName = afterMethodName,dataSourceFactory = dataSourceFactory,subredditName = subredditName)
